...
import heroImage from "../../assets/man-inserting-light-bulbs-into-chandelier.png";
  ...
  return (
    <div className="mx-auto w-full max-w-7xl">
      <aside className="relative mx-2 overflow-hidden rounded-lg text-black sm:mx-16 sm:py-16">
        <div className="relative z-10 mx-auto max-w-7xl px-4 pt-10 pb-20 sm:px-6 sm:py-24 lg:px-8">
          <div className="mt-80 max-w-xl space-y-8 text-center sm:mt-1 sm:ml-auto sm:text-right">
      ...
      <div className="grid place-items-center sm:mt-20">
        <img className="w-48 sm:w-96" src={heroImage} alt="image2" />
      </div>
