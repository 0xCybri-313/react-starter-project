...
export default function Contact() {
  return (
    <div className="items-top relative flex min-h-175 justify-center bg-white sm:items-center sm:pt-0">
            ...
            <form className="flex flex-col justify-center p-6">
              <div className="flex flex-col">
                ...
                <input
                  ...
                  className="mt-2 w-100 rounded-lg border border-gray-400 bg-white px-3 py-3 font-semibold text-gray-800 focus:border-orange-500 focus:outline-none"
                />
              </div>
